...
# Own modules
from Network_generator_2 import generate_data
...
# flow_x.to_csv("flow_x_2.csv")

print("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  Flow_w dataframe")
print(flow_w.to_string())
# flow_w.to_csv("flow_w_2.csv")

print("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Total_capacity dataframe")
print(total_capacity.to_string())
# total_capacity.to_csv("total_capacity_2.csv")

print("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ demand_df dataframe")
print(demand_df.to_string())
# demand_df.to_csv("demand_df_2.csv")
...
colors = '''blue,red,green,yellow,blue,purple,orange,lime,pink,orange,violet,lime,red,yellow,green,violet'''
