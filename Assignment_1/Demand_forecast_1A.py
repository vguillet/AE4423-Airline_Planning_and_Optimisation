...
class Demand_forcast():
        ...
        for airport_i in matches:
            for airport_j in matches:
                if airport_i != airport_j:
                    ...
                    # the training y is de avarage of the demand back and forth because the gravity model is symmetrical
    ...
    def save(self,file_name = "Demand_forecast_2030.csv"):
    ...
    def print(self):
        ...
        print('\nOptimized gravity model:')
        print(f' - k  = {round(self.k,4)}')
        print(f' - b1 = {round(self.b1,4)}')
        print(f' - b2 = {round(self.b2,4)}')
